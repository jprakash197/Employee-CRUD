...
public class EmployeeWithoutIdDTO implements Serializable {
	...
	public EmployeeWithoutIdDTO() {
	}

	public EmployeeWithoutIdDTO(@Size(min = 2, message = "Name should have atleast 2 characters.") @NotNull String name,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EmployeeWithoutIdDTO other = (EmployeeWithoutIdDTO) obj;
		if (compitency == null) {
